...
public class BlockGyroscopeStabilizer extends BaseBlock implements ITileEntityProvider, IBlockTorqueProvider {
    ...
    public Vector3dc getTorqueInGlobal(PhysicsCalculations physicsCalculations, BlockPos pos) {
        ...
        if (!(thisTile instanceof TileEntityGyroscopeStabilizer tileGyroscope)) return null;
